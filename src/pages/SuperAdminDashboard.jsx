            ...
            {section === 'prospecting' && (
              <div>
                ...
                <div style={{ background: c.card, border: `1px solid ${c.border}`, borderRadius: '16px', padding: '32px', textAlign: 'center' }}>
                  ...
                  <p style={{ color: c.muted, fontSize: '15px' }}>Outbound prospecting tool — building now.</p>
                  <p style={{ color: c.muted, fontSize: '14px', marginTop: '8px' }}>3 templates approved ✅ · Google Sheets sync · Single contact add</p>
                </div>
              </div>
            )}
