  ...
  return (
    <div style={{ fontFamily:"'Outfit', sans-serif", background:t.bg, color:t.text, minHeight:'100vh' }}>
      ...
      <div style={{ maxWidth:'800px', margin:'0 auto', padding:'60px 24px' }}>
        <p style={{ color:t.lime, fontSize:'12px', fontWeight:'700', letterSpacing:'0.1em', textTransform:'uppercase', marginBottom:'16px' }}>
          Legal
        </p>
        <h1 style={{ fontFamily:"'Fraunces', serif", fontSize:'clamp(32px, 5vw, 52px)', fontWeight:'900', marginBottom:'8px' }}>
          {title}
        </h1>
